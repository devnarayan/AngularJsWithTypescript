...
module AngularWithTypescriptApp {
    export class Config {
    ...
    export class TechVidsCategoryCtrl implements angular.IController {
    ...
    export class TechVidsListCtrl implements angular.IController {
    ...
    export class EditTechVideoCtrl implements angular.IController {
    ...
    export class AddVideoCtrl implements angular.IController {
    ...
    export class UniqueVideoTitle {
        public static UniqueVideoTitleDirective(dataSvc: TechVidsDataSvc): ng.IDirective {
            return {
                require: 'ngModel',
                link: function (scope: ng.IScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes, ctrl: ng.IController) {
