...
var AngularWithTypescriptApp;
(function (AngularWithTypescriptApp) {
    ...
    AngularWithTypescriptApp.Config = Config;
    Config.$inject = ['$routeProvider'];
    var TechVidsDataSvc = /** @class */ (function () {
        ...
        TechVidsDataSvc.prototype.getAllVideos = function (fetchFromService) {
            ...
            function getVideosFromService() {
                ...
                Workpulse.Site.AjaxApi({
                    url: self.techVidsApiPath,
                    data: {},
                    type: 'GET',
                    ...
                    error: function (data, textStatus) {
                        Workpulse.Site.Alert('Unable to generate the report.');
                    },
                    complete: function () {
                    }
                });
    ...
    AngularWithTypescriptApp.TechVidsDataSvc = TechVidsDataSvc;
    var TechVidsCategoryCtrl = /** @class */ (function () {
        function TechVidsCategoryCtrl($scope, techVidsDataSvc) {
            this.$scope = $scope;
            this.dataSvc = techVidsDataSvc;
            this.init();
        }
        TechVidsCategoryCtrl.prototype.$onInit = function () { };
    ...
    AngularWithTypescriptApp.TechVidsCategoryCtrl = TechVidsCategoryCtrl;
    TechVidsCategoryCtrl.$inject = ['$scope', 'techVidsDataSvc'];
    var TechVidsListCtrl = /** @class */ (function () {
        ...
        TechVidsListCtrl.prototype.$onInit = function () { };
    ...
    AngularWithTypescriptApp.TechVidsListCtrl = TechVidsListCtrl;
    TechVidsListCtrl.$inject = ['$scope', '$routeParams', 'techVidsDataSvc'];
    var EditTechVideoCtrl = /** @class */ (function () {
        ...
        EditTechVideoCtrl.prototype.$onInit = function () { };
    ...
    AngularWithTypescriptApp.EditTechVideoCtrl = EditTechVideoCtrl;
    EditTechVideoCtrl.$inject = ['$scope', '$routeParams', '$window', 'techVidsDataSvc'];
    var AddVideoCtrl = /** @class */ (function () {
        ...
        AddVideoCtrl.prototype.$onInit = function () { };
    ...
    AngularWithTypescriptApp.AddVideoCtrl = AddVideoCtrl;
    AddVideoCtrl.$inject = ['$scope', '$window', 'techVidsDataSvc'];
    var UniqueVideoTitle = /** @class */ (function () {
                ...
                link: function (scope, element, attrs, ctrl) {
                    element.bind('blur', function () {
                        ...
                        dataSvc.checkIfVideoExists(viewValue).then(function (result) {
                            if (result === "true") {
                                element.addClass("uniqueVideoTitle");
                            }
                            else {
                                element.removeClass("uniqueVideoTitle");
                            }
                        }, function (error) {
                            element.removeClass("uniqueVideoTitle");
                        });
    ...
    AngularWithTypescriptApp.UniqueVideoTitle = UniqueVideoTitle;
...
})(AngularWithTypescriptApp || (AngularWithTypescriptApp = {}));
